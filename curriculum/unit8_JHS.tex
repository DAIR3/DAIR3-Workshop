...
\begin{landscape}
    ...
    \begin{longtable}{>{\RaggedRight\arraybackslash}p{2.8cm} >{\RaggedRight\arraybackslash}p{3cm} >{\RaggedRight\arraybackslash}p{2.5cm} >{\RaggedRight\arraybackslash}p{2.5cm} >{\RaggedRight\arraybackslash}p{2.5cm}}
    \toprule
    ...
    \textbf{Variable Identification (50\%)} 
    & Accurately identifies variables; clear rationale; demonstrates deep understanding of JHS datasets 
    & Minor omissions but overall strong alignment 
    & Adequate but limited justification 
    & Incomplete or incorrect variable selection \\
    \midrule

    \textbf{Manuscript Proposal (50\%)} 
    ...
    \textbf{Overall Professionalism and Clarity} 
