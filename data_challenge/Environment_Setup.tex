...
for the program. The instructions involve navigating folders and
entering commands in a terminal. If you are not yet familiar with
these concepts, do not worry: they are explained in full in
Chapter~\ref{ch:cli-scripting}. You do not need to read that chapter
before completing the installation steps here.
\vs
...
\vs
Virtual environment setup and workflow automation are covered in
Chapter~\ref{ch:python-environments}.
\vs
...
%================================================================
\section{Required: Jupyter Notebook}\label{sec:jupyter}
%================================================================
...
%================================================================
\section{Installing the Latest Stable PostgreSQL on Linux}
%================================================================
...
%================================================================
\section{Installing LaTeX Tools on Linux}
%================================================================
